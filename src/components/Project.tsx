...
const Project: React.FC<ProjectProps> = ({
  ...
  return (
    <div className="project mb-8 p-8 bg-background rounded-lg shadow-md grid grid-cols-1 sm:grid-cols-2 gap-8">
      <a
      ...
      <div className="project-details flex flex-col justify-center">
        ...
        <div className="buttons flex justify-between mt-4">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="w-1/2 p-2 text-first border-b-2 border-text hover:bg-text hover:text-white text-center"
          >
